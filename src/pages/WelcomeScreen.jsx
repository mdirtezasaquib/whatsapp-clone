  ...
  return (
    <div className="min-h-screen  bg-gradient-to-br from-[#e5f4ed] via-white to-[#daf4e9] text-teal-600 flex flex-col justify-between items-center px-6 py-2 relative">
      ...
      <div className="w-full mt-10 space-y-4">
        ...
        <button
          className="w-full bg-[#25D366] hover:bg-[#1db954] text-white py-3 rounded-full font-bold transition duration-300"
      ...
      <div className="text-center text-xs text-gray-400 mt-6 px-4 leading-snug">
        By clicking above, you promise to vibe responsibly. Also, you agree to our{" "}
        <span className="underline">Terms</span>,{" "}
        <span className="underline">Privacy Policy</span>, and accept our delicious{" "}
